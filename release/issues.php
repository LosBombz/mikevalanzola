...
<body>
  ...
  <div data-module="res-slider-module" class="slider-container">
    <ul class="slider">
      <li>
        <img src="images/content/mike-selectmen.jpg" alt="Mike at work with the East Brookfield Selectmen." />
      </li>
    </ul>
  </div>
  

  <h1>Mike on the Issues</h1>
...
<div class="issues-container">
    ...
    <div class="content-container">
      <ul class="issues">
        ...
        <li>Refuse to reward illegals with in-state tuition or drivers licenses.</li>
