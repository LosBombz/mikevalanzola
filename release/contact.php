...
<head>
	...
	<script>
		...
		grunticon( [ "styles/css/icons.data.svg.css", "styles/css/icons.data.png.css", "styles/css/icons.fallback.css" ] );
	</script>
		...
		<div class="content-container">
			<div class="volunteer-form"> 
				...
				<form id="form1" name="form1" class="wufoo topLabel page" accept-charset="UTF-8" autocomplete="off" enctype="multipart/form-data" method="post" novalidate
				      action="https://wmurray.wufoo.com/forms/z119zysg0hcdrdq/#public">
				  
				<div id="header" class="info">
					<h2>Volunteer Form</h2>
					<div>Please fill out any contact information and relevant volunteer information.</div>
				</div>
				...
				<li id="foli9" class="phone notranslate      ">
				<label class="desc" id="title9" for="Field9">
				Phone Number
				<span id="req_9" class="req">*</span>
				</label>
				<span>
				<input id="Field9" name="Field9" type="tel" class="field text" value="" size="3" maxlength="3" tabindex="9" required />
				<label for="Field9">###</label>
				</span>
				<span class="symbol">-</span>
				<span>
				<input id="Field9-1" name="Field9-1" type="tel" class="field text" value="" size="3" maxlength="3" tabindex="10" required />
				<label for="Field9-1">###</label>
				</span>
				<span class="symbol">-</span>
				<span>
				 <input id="Field9-2" name="Field9-2" type="tel" class="field text" value="" size="4" maxlength="4" tabindex="11" required />
				...
				<div>
				<input id="Field11" name="Field11" type="email" spellcheck="false" class="field text medium" value="" maxlength="255" tabindex="12" />
				</div>
				</li>
				<li id="foli12" class="notranslate  twoColumns     ">
				<fieldset>
				<![if !IE | (gte IE 8)]>
				...
				<div>
				<span>
				<input id="Field12" name="Field12" type="checkbox" class="field checkbox" value="Lawn Sign" tabindex="13" />
				<label class="choice" for="Field12">Lawn Sign</label>
				</span>
				<span>
				<input id="Field13" name="Field13" type="checkbox" class="field checkbox" value="Assist in the office" tabindex="14" />
				<label class="choice" for="Field13">Assist in the office</label>
				</span>
				<span>
				<input id="Field14" name="Field14" type="checkbox" class="field checkbox" value="Phone Campaign" tabindex="15" />
				<label class="choice" for="Field14">Phone Campaign</label>
				</span>
				<span>
				<input id="Field15" name="Field15" type="checkbox" class="field checkbox" value="Door to Door Campaign" tabindex="16" />
				<label class="choice" for="Field15">Door to Door Campaign</label>
				</span>
				<span>
				<input id="Field16" name="Field16" type="checkbox" class="field checkbox" value="Standout Campaign" tabindex="17" />
				<label class="choice" for="Field16">Standout Campaign</label>
				</span>
				<span>
				<input id="Field17" name="Field17" type="checkbox" class="field checkbox" value="Election Day Volunteer" tabindex="18" />
				<label class="choice" for="Field17">Election Day Volunteer</label>
				</span>
				</div>
				</fieldset>
				<p class="instruct" id="instruct12"><small>Check at least one.</small></p>
				</li> <li class="buttons ">
				<div>
		    ...
		    <input id="saveForm" class="button red volunteer" name="saveForm" type="submit" value="Volunteer" />
				...
				<input type="hidden" id="idstamp" name="idstamp" value="JCpbJUGiPdyeOvn4Kkj83uBrKXyr164hLVsGZwA+n/w=" />
				</li>
				</ul>
				</div> <!--- container -->
				<!--END WOOFU FORM-->
